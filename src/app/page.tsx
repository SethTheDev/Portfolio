    ...
    <main className="flex min-h-screen flex-col justify-between p-12">
      ...
      <div className="reviews pt-20">
        ...
        <div className="reviews-container justify-center flex flex-row flex-wrap gap-10">
            ...
            <Review name="BigC" avatar="https://cdn.discordapp.com/avatars/1026351894580445208/b712a79cb334c7dcff500ee0c732977f?size=1024" description="Seth is a great coder who has been helping me make a mod for minecraft with Python script. (and he is my pookie bear forever)" />
